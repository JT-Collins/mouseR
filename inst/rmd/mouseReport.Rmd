...
per_weight_DF |>  
  ...
  labs(title = "Percent Weight Change by mouse", 
      subtitle = "Normalized to day zero <br><span style = 'color:#AD0000;'>Male</span> and <span style = 'color:#8B9DA1;'>Female</span> mice",
      caption = paste0("(Figure generated on ", Sys.Date(), ")")) +
  xlab("Time in days") +
  ylab("Percent weight") +
...
clinical |>
  ...
  ggplot() +
  geom_point(aes(x=day, y=total_score)) +
  stat_summary(aes(y = total_score, x = day, group=1), fun=mean, colour="red", geom="line", group=1) +
